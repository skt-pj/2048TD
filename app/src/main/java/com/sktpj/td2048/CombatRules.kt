...
internal object StarterRoster {
    val characters: List<CharacterDefinition> = listOf(
        CharacterDefinition("r1", "紅蓮", HandType.ROCK, 96, 1.10f, 950, CharacterAbility.BOSS_BONUS),
        CharacterDefinition("s1", "蒼刃", HandType.SCISSORS, 102, 1.05f, 900),
        CharacterDefinition("p1", "翠風", HandType.PAPER, 104, 1.00f, 900, CharacterAbility.SLOW),
        CharacterDefinition("r2", "火槍", HandType.ROCK, 98, 1.08f, 1000),
        CharacterDefinition("s2", "氷刃", HandType.SCISSORS, 108, 0.96f, 850, CharacterAbility.SLOW),
        CharacterDefinition("p2", "森弓", HandType.PAPER, 112, 1.00f, 950),
        CharacterDefinition("r3", "赤盾", HandType.ROCK, 126, 0.90f, 1050),
        CharacterDefinition("s3", "青槍", HandType.SCISSORS, 110, 1.04f, 950),
        CharacterDefinition("p3", "緑術", HandType.PAPER, 106, 1.08f, 1050, CharacterAbility.BOSS_BONUS),
        CharacterDefinition("r4", "焔騎", HandType.ROCK, 118, 0.98f, 900),
        CharacterDefinition("s4", "迅影", HandType.SCISSORS, 100, 1.12f, 850),
        CharacterDefinition("p4", "樹守", HandType.PAPER, 130, 0.88f, 1100, CharacterAbility.SLOW),
        CharacterDefinition("r5", "烈牙", HandType.ROCK, 116, 1.02f, 900),
        CharacterDefinition("s5", "月鋏", HandType.SCISSORS, 114, 1.00f, 900, CharacterAbility.BOSS_BONUS),
        CharacterDefinition("p5", "葉雨", HandType.PAPER, 120, 0.96f, 850),
        CharacterDefinition("r6", "岩拳", HandType.ROCK, 138, 0.86f, 1100),
    )
}
