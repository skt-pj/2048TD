const EN = {
  ...
  previousBest: "PREVIOUS BEST", detailsUnavailable: "Details were not saved for this older result.",
...
const JA = {
  ...
  previousBest: "以前のベストスコア", detailsUnavailable: "この成績のWAVE・最大タイル・日時は保存されていません。",
